...
function init()
  ...
  if not g_app.isMobile() then
    questLogButton = modules.client_topmenu.addRightGameToggleButton('questLogButton', tr('Quest Log'), '/images/topbuttons/questlog', function() g_game.requestQuestLog() end, false, 8)
