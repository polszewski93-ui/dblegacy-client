-- CONFIG
APP_NAME = "DBLegacy"  -- important, change it, it's name for config dir and files in appdata
APP_VERSION = 860       -- client version for updater and login to identify outdated clien
...
Servers = {
  entergame = "dblegacy.pl:7171:860"
}
